...
public static void main(String[] args) throws IOException {
    ...
    String dhdan_path;
    String dhdan_dst;
    String hpuma_path = "C:\\Users\\pumah\\Desktop\\Src_Folder\\US_eMTH_NDVI.2000.056-062.QKM.COMPRES.005.2009221053420";
    String hpuma_dst =  "C:\\Users\\pumah\\Desktop\\Dump_Folder";

    // Source of input folders
    ...
    if(Files.exists(path) && Files.isDirectory(path) && Files.exists(dst) && Files.isDirectory(dst)) {
            // Printing the directories contents
